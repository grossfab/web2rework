...
try {
    ...
    // binding endpoints
    // Include service classes / handlers in the server 
    ...
    var buchungsRouter = require('./routes/buchen.js');
    app.use('/buchen', buchungsRouter);
    //CHECKEN: Muesste der Service Router  nicht auf bzw. die buchungsanfrageDao.js nicht in ./services liegen? 
    // CHECKEN: Wieso wird hier TOPLEVELPATH, ./api verwendet? Korrekt?
    var serviceRouter = require('./dao/buchungsanfrageDao.js');
    app.use(TOPLEVELPATH, serviceRouter);

    //folgender code in routes/index.js abbilden?
